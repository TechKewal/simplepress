...
To set up Moderation Emails use the Options link below the plugin name or go to the <b>Email Settings</b> panel in the <b>Options</b> section
</div>
...
This plugin does not add any new permission:
</div>

<div class="tipSection">
<h3><span class="spaicon-Log">&nbsp;</span>Further Information</h3>
Visit this plugin's <a href="
https://simple-press.com/documentation/plugins/our-plugins/available-plugins/moderation-email/
