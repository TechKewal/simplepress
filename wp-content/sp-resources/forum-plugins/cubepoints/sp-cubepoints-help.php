...
To set up CubePoints integration how you want it use the Options link below the plugin name or go to the panel in the <b>Components</b> section. The WordPress CubePoints plugin is required to be installed and active
</div>
...
There are no new permissions associated with this plugin
</div>

<div class="tipSection">
<h3><span class="spaicon-Log">&nbsp;</span>Further Information</h3>
Visit this plugin's <a href="
https://simple-press.com/documentation/plugins/our-plugins/available-plugins/cubepoints/
