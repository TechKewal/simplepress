...
/* 	=====================================================================================
	sp_do_sp_ShowForumRankTag($userid, $args)

	displays forum rank for the specified user
	...
	parameters:
 	...
 	===================================================================================*/
function sp_do_sp_ShowForumRankTag($userid, $args='') {
    #check if forum displayed
    if (sp_abort_display_forum()) return;

	if (empty($userid)) return;

	$defs = array('tagClass'	=> 'spForumRankTag',
				  'titleClass'	=> 'spForumRankTag',
			 	  'badgeClass'	=> 'spForumRankTag',
				  'showTitle'	=> 1,
				  'showBadge'	=> 1,
				  'echo'		=> 1,
				  );
    ...
    $data = sp_UserForumRank($a, $thisUser->rank);
...
function sp_do_ShowForumRankShortcode($atts) {
    $args = array();
    $userid = $atts['userid'];
