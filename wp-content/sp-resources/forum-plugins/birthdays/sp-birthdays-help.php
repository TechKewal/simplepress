...
To set up Birthdays use the Options link below the plugin name name or go to the <b>General Display Settings</b> panel in the <b>Options</b> section
</div>
...
https://simple-press.com/documentation/plugins/our-plugins/available-plugins/birthdays/
