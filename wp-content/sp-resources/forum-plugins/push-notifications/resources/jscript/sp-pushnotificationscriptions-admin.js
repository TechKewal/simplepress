/* ---------------------------------
Simple:Press
Push Notifications Plugin Admin Javascript
------------------------------------ */
...
(function(spj, $, undefined) {
	...
	***********************************************/
	...
	sp_subs_show_subs = {
		init : function() {
			$('#sfmaincontainer').on('click', '.spPushNotificationsShowSubs', function(event) {
	...
	sp_subs_search_subs = {
		init : function() {
			$('#sptopicusers, #sptopicsubs, #spforumsubs').submit( function(event) {
				var mydata = $(this).data();
				event.preventDefault();
				showSubsList(mydata.target, mydata.site, mydata.img);
			});
