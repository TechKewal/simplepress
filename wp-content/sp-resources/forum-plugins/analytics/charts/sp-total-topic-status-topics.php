...
class SP_Chart_Total_Topic_Status_Topics extends SP_Chart_Topic_Status {
    protected $id = 'total_topic_status_topics';
    ...
    function dataPoints() {
		...
		$sql = "SELECT COUNT(*) `count`,
				...
				WHERE f.topic_status_set > 0 GROUP BY f.topic_status_set, t.topic_status_flag";
