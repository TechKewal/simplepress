...
To Prune the Database use the Options link below the plugin name or go to the panel in the <b>Toolbox</b> section
</div>
...
https://simple-press.com/documentation/plugins/our-plugins/available-plugins/prune-database/
