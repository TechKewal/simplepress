			...
			if (SP()->forum->view->this_topic()):
				...
				sp_SectionStart('tagClass=spTopicViewSection', 'eachTopic');
					...
					sp_SectionStart('tagClass=spTopicViewHeader', 'topicHeader');
						...
						# ----------------------------------------------------------------------
						sp_SectionStart('tagClass=spActionsBar', 'topicHeadButtons');
					...
					sp_SectionStart('tagClass=spTopicPostContainer', 'topicViewPosts');
						...
						sp_SectionStart('tagClass=spTopicPostSection', 'eachPost');
							...
							sp_ColumnStart('tagId=spColTopic1&tagClass=spUserSection spLeft&width=0&height=50px');
								...
								sp_SectionStart('tagClass=spSocialButtons spCenter', 'postUserIdentities');
							...
							sp_ColumnStart('tagId=spColTopic2&tagClass=spPostSection spRight&width=0');
								...
								sp_SectionStart('tagClass=spPostContentHolder', 'postPlugins');
				...
				# ----------------------------------------------------------------------
				sp_SectionStart('tagClass=spPageLinksBottomSection', 'topicPageLinksFoot');
